package com.controledegastos.excecao;
...
public class ManipuladorExcecao extends ResponseEntityExceptionHandler {
	...
	private String tratarMensagemDeErroParaUsuario(FieldError fieldError) {
		...
		if(fieldError.getCode().equals(CONSTANT_VALIDATION_MAX)) {
			return fieldError.getDefaultMessage().concat(String.format(" deve ter no maximo %s caracteres.", fieldError.getArguments()[1]));
		}
